                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <ul id="pagination">
				            	<!-- 맨 처음으로 -->
				                <li><a href="${ path }/mypage/writeFreeBoard?page=1">«</a></li>
				                
				                <!-- 이전 페이지로 -->
				                <li><a href="${ path }/mypage/writeFreeBoard?page=${ pageInfo.prevPage }">‹</a></li>
								...
								<c:forEach begin="${ pageInfo.startPage }" end="${ pageInfo.endPage }" varStatus="status">
									...
									<c:if test="${ status.current != pageInfo.currentPage }">
				                		<li><a href="${ path }/mypage/writeFreeBoard?page=${ status.current }">${ status.current }</a></li>
									</c:if>
								</c:forEach>
								
								<!-- 다음 페이지로 -->
									<li><a href="${ path }/mypage/writeFreeBoard?page=${ pageInfo.nextPage }">›</a></li>  
								<!-- 맨 끝 페이지로 -->
					                <li><a href="${ path }/mypage/writeFreeBoard?page=${ pageInfo.maxPage }">»</a></li>
				            </ul>
                        </div>
