...
<!-- 내용 전체 컨테이너 -->
    <div class="container mt-5">
        ...
        <!-- 후기글 전체 -->
		<form action="${path}/product/product_update" method="post" enctype="multipart/form-data">
                ...
                <table class="table m-0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" name="pcategory" style="width: 50%;" value="${ product.pcategory }"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="number" name="pqtt" style="width: 50%;" value="${ product.pqtt }"></td>
                        </tr>
                        <tr>
                            <th class="table-active">상품 가격</th>
                            <td><input type="number" name="pprice" style="width: 50%;" value="${ product.pprice }"></td>
                        </tr>
                        <tr>
