            ...
            <div class="col-sm-10">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12" style="margin-top: 40px;">
                            <form style="margin-bottom: 3px;">
                                <h5 class="rightMainMenu" style="font-weight: 600;" onclick="location.href='${path}/mypage/dibsContent'">찜한 컨텐츠</h5>
                                <hr>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="pl-3 pr-4 row" style="margin-top: 10px; height: 40px;">
						<c:if test="${ type == '영화' }">
							<div class="col-3 mycategory" style="background-color: rgb(90, 97, 224); color: white;" onclick="location.href='${path}/mypage/dibsContent?type=영화'">
						</c:if>
						<c:if test="${ type != '영화' }">
						    <div class="col-3 mycategory" onclick="location.href='${path}/mypage/dibsContent?type=영화'">
						</c:if>                    	
                            MOVIE
                        </div>
                        
						<c:if test="${ type == 'TV' }">
							<div class="col-3 mycategory" style="background-color: rgb(90, 97, 224); color: white;" onclick="location.href='${path}/mypage/dibsContent?type=TV'">
						</c:if>
						<c:if test="${ type != 'TV' }">
						    <div class="col-3 mycategory" onclick="location.href='${path}/mypage/dibsContent?type=TV'">
						</c:if>                    	
                            TV
                        </div>

						<c:if test="${ type == '도서' }">
							<div class="col-3 mycategory" style="background-color: rgb(90, 97, 224); color: white;" onclick="location.href='${path}/mypage/dibsContent?type=도서'">
						</c:if>
						<c:if test="${ type != '도서' }">
						    <div class="col-3 mycategory" onclick="location.href='${path}/mypage/dibsContent?type=도서'">
						</c:if>                    	
                            BOOK
                        </div>
                        
						<c:if test="${ type == '웹툰' }">
							<div class="col-3 mycategory" style="background-color: rgb(90, 97, 224); color: white; border-right: 1px solid grey;" onclick="location.href='${path}/mypage/dibsContent?type=웹툰'">
						</c:if>
						<c:if test="${ type != '웹툰' }">
						    <div class="col-3 mycategory" style="border-right: 1px solid grey;" onclick="location.href='${path}/mypage/dibsContent?type=웹툰'">
						</c:if>                    	
                            WEBTOON
                        </div>     
                    </div>
                            		...
                            		<li class="item">
	                                    <div class="item_poster">
	                                        <div class="thumb_item" style="width: 187px; height: 273px;">
	                                            <div class="poster_movie" style="z-index: 2;">
	                                                <img onclick="location.href='${path}/contents/contents_detail?no=${ contents.c_no }'" style="z-index:3; cursor: pointer;" src="${ path }/resources/uploadFiles/contents/${ contents.c_pimg }"
	                                                    class="img_thumb" onerror=this.src="${path}/resources/img/common/noImage.png">
	                                                <span style="z-index: 5; cursor: pointer;" class="txt_tag">
	                                                    <span class="ico_movie ico_see see${ contents.c_age }">${ contents.c_age }세이상관람가</span>
	                                                </span>
		                                            <span class="mx-2 my-1" style="left:3px; top:5px; position: absolute; z-index: 4;">
					...
					<div class="row">
            			...
            			<div class="col-4 text-right">
            				<button id="btn_deleteDibsContent" class="btn btn-logoc mt-3 mr-4">삭제하기</button>
            			</div>
                    </div>
