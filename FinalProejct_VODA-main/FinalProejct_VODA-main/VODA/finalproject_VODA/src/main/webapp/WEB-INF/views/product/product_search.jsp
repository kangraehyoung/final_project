...
<br>
    ...
    <div class="display1 row my-3">
            ...
            <ul id="pagination">
            	<!-- 맨 처음으로 -->
                <li><a href="${ path }/product/product_search?page=1&searchtype=${searchtype}&searchname=${searchname}">«</a></li>
                
                <!-- 이전 페이지로 -->
                <li><a href="${ path }/product/product_search?page=${ pageInfo.prevPage }&searchtype=${searchtype}&searchname=${searchname}">‹</a></li>
				...
				<c:forEach begin="${ pageInfo.startPage }" end="${ pageInfo.endPage }" varStatus="status">
					...
					<c:if test="${ status.current != pageInfo.currentPage }">
                		<li><a href="${ path }/product/product_search?page=${ status.current }&searchtype=${searchtype}&searchname=${searchname}">${ status.current }</a></li>
					</c:if>
				</c:forEach>
				
				<!-- 다음 페이지로 -->
					<li><a href="${ path }/product/product_search?page=${ pageInfo.nextPage }&searchtype=${searchtype}&searchname=${searchname}">›</a></li>  
				<!-- 맨 끝 페이지로 -->
	                <li><a href="${ path }/product/product_search?page=${ pageInfo.maxPage }&searchtype=${searchtype}&searchname=${searchname}">»</a></li>
            </ul>
